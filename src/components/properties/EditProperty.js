...
const EditProperty = () => {
    ...
    try {
      ...
      if (propertyData) {
        setFormData({
          ...
          images: propertyData.images ? propertyData.images.map(img => ({ preview: img })) : []
        });
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const imageData = formData.images.map(img => img.preview);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`input-field pl-8 ${errors.location ? 'border-red-500 focus:ring-red-500' : ''}`}
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`input-field ${errors.propertyType ? 'border-red-500 focus:ring-red-500' : ''}`}
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`input-field ${errors.furnished ? 'border-red-500 focus:ring-red-500' : ''}`}
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`input-field pl-8 ${errors.bedrooms ? 'border-red-500 focus:ring-red-500' : ''}`}
                  placeholder="2"
                  min="0"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`input-field pl-8 ${errors.bathrooms ? 'border-red-500 focus:ring-red-500' : ''}`}
                  placeholder="1"
                  min="0"
                  step="0.5"
                />
